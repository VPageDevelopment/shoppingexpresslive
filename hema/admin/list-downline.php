                                  ...
                                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tbody>
                                      <?php 
                                         ...
                                         $sql = "select * from user where referalid in (select userid from user where referalid = 'SE011032') or referalid = 'SE011032' ;";
                                      ...
                                      ?>
                                         ...
                                         ?>
                                            <tr>
                                              ...
                                              <td><?php echo $table_userid; ?></td>
                                              <td><?php echo $table_sponserid; ?></td>
                                            </tr>
                                         <?php
