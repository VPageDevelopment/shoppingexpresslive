  ...
  <head>
    ...
    <style>
        ...
        .nav-md ul.nav.child_menu li:before{
          background:1px solid rgba(82, 104, 66, 0.46);
        }

        .text-color{
          color:#b0ddce !important;
        }
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="home.php" class="site_title"><span class="text-color">Shopping Express</span></a>
            </div>
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span class="text-color">Welcome,</span>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
					...
					<li><a href="pin.php"><i class="fa fa-key"></i> E-Pin </a></li>
					
					<li><a href="list-downline.php"><i class="fa fa-list"></i>List Downline </a></li>
          <li><a href="income.php"><i class="fa fa-money"></i>Earnings</a></li>
