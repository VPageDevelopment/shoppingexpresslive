...
include_once( 'connection.php');
	...
	if(isset($_REQUEST['sno']) && !empty($_REQUEST['sno']))
	{
		...
		echo $sql = "UPDATE pack1 SET productcode = '$productcode', package='$package',title='$title',description='$description',  actualprice = '$actualprice' , fabrictype = '$fabrictype',feathures='$feathures',packimage='$location',attachmentname='$image_name'  WHERE sno='$sno' ";
	...
	else
	{
		...
		{  
			...
			{    
				...
				echo $sql="INSERT INTO pack1(productcode , package,title,description,  actualprice, fabrictype ,feathures,packimage,attachmentname,status) 
				VALUES( '$productcode','$package','$title','$description','$actualprice','$fabrictype' ,'$feathures','$location','$image_name',0)";
