            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                ?>
					...
					<li><a><i class="fa fa-key"></i> E-Pin Management <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
						  <li><a href="epin.php">Generate  E-Pin </a></li>
						  <li><a href="epin-gen.php"> E-Pin Request </a></li>
						</ul>
					</li>
				
					<li><a href="report.php"><i class="fa fa-newspaper-o "></i> Report </a></li>
				...
				<?php 
                  ...
                  if($_SESSION['SESS_ROLE'] != 'admin')
				  {
					echo '<li><a><i class="fa fa-key"></i> E-Pin Management <span class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu">
								  <li><a href="epin-req.php"> E-Pin Request</a></li>
								  <li><a href="pinstore.php">Pin Store</a></li>
								</ul>
							</li>';
					
					echo '<li><a href="purchased_pro.php"><i class="fa fa-shopping-cart"></i> Purchased Products</a></li>';
				  }
                ?>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="changepsw.php">Change Paswword	</a></li>
