...
if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
{
	...
	foreach ($_SESSION["cart_products"] as $cart_itm)
	{
		...
		echo '<td class="cart-item">Qty <input type="text" size="2" maxlength="2" name="product_qty['.$product_code.']" value="'.$product_qty.'" /></td>';
	...
	echo '<td colspan="4">';
	echo '<button type="submit" class=" btn btn-primary  update "><i class="fa fa-wrench  fa-lg"></i> Update</button><a href="view_cart.php" class="button btn btn-primary checkout "><i class="fa fa-truck  fa-lg"></i> Checkout</a>';
	echo '</td>';
	echo '</tbody>';
	echo '</table>';
