							...
							<div class="x_panel">
								<div class="x_title">
									...
									<ul class="nav navbar-right panel_toolbox">
										...
										<li><a href="#" ><i class="fa fa-print" style="font-size:25px;" onClick="PrintElem('#pdfdownload')"></i></a>	
										</li>
										...
										mywindow.document.write("</head><body> <div style='border-bottom: 1px solid black;width:178px;margin-left:200px;margin-bottom:2px;'>"+txt.fontsize(5)+"</div>");
								...
								<form action="" method="post">
									<div id="pdfdownload" class="invoice-box">
										...
										<tr class="item">
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;">  <?php echo $title;?></td>
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;"> <?php echo $package;?></td>
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;">  <?php echo $quantity;?></td> 
											<td style="padding:5px; vertical-align:top;text-align:right;border-bottom: 1px solid #eee;"> Rs :<?php echo $price;?></td>
										</tr>
										<tr class="item">
											...
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;"> </td>
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;text-align:right;"> Rs :<?php echo $tax;?></td>
										</tr>
										<tr class="total">
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;"></td>
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;"></td> 
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;"> </td>
											<td style="padding:5px; vertical-align:top;border-bottom: 1px solid #eee;text-align:right;"> Total : &nbsp;&nbsp;&nbsp; Rs :<?php echo $total;?>  </td>  
										</tr>
									</table>
