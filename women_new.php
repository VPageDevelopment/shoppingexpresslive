...
if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
{
	...
	echo '<td colspan="4">';
	echo '<button type="submit" class=" btn btn-primary  update ">Update</button><a href="view_cart.php" class="button btn btn-primary checkout ">Checkout</a>';
	echo '</td>';
	echo '</tbody>';
	echo '</table>';
...
$products_item .= <<<EOT
	...
	<div align="center"><button type="submit" class="class="add_to_cart btn btn-primary  btn-block add-to-cart""><i class="fa fa-cart-plus  fa-lg"></i> Add Cart </button></div>
	</div></div>
	</form>
	</div>
EOT;
